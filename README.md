...
```  
If using NNLS, the amplitudes are ignored, and this lens light model only introduces $4\times3=12$ nonlinear parameters for sampling. For comparison, if not using NNLS, the number of sampling parameters become $3\times(30 + 4)=102$.  

## Future
The pixelated source model is not fully tested yet.  

## Acknowledgement
These scripts are mostly generated by AI code editor [Cursor](https://cursor.com/home), and modified manually. 